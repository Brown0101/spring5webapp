...
public class BootSrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Publisher publisher = new Publisher("Ace Books", "123 ACME Avenue", "New York City", "NY", "10004");
        ...
        System.out.println("Number of Books Assigned to a Publishers: " + publisher.getBooks().size());
    }
}
